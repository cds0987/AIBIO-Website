...
class MiniSentenceTransformer:
    def __init__(self, model_name='sentence-transformers/all-MiniLM-L12-v2'):
        ...
        """
        self.tokenizer = AutoTokenizer.from_pretrained(model_name, cache_dir="AI_Model/AI_model_cache/HuggingFace")
        self.model = AutoModel.from_pretrained(model_name, cache_dir="AI_Model/AI_model_cache/HuggingFace")
...
class RetrieveInformation:
    ...
    def __init__(self, chunk_size=200):
        ...
        self.tokenizer = AutoTokenizer.from_pretrained("bert-base-uncased", cache_dir="AI_Model/AI_model_cache/HuggingFace")
