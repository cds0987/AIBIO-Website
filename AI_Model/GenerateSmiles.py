...
class GenerateMOLT5(nn.Module):
    def __init__(self):
        ...
        self.smiles_model = T5ForConditionalGeneration.from_pretrained('laituan245/molt5-small-caption2smiles',cache_dir="AI_Model/AI_model_cache/HuggingFace")
        self.smiles_tokenizer=T5Tokenizer.from_pretrained("laituan245/molt5-small-caption2smiles", model_max_length=512,cache_dir="AI_Model/AI_model_cache/HuggingFace")
