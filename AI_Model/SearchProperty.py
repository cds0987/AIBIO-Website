...
class SmilesSearching():
  def __init__(self):
    csv='AI_Model/AI_model_cache/Property Searching/bbbp.csv'
    df=pd.read_csv(csv)
    smiles=df['smiles']
    labels=df['target']
    ...
    self.bbbp_ebd1=torch.load('AI_Model/AI_model_cache/Property Searching/bbbp_embeddings1.pt',weights_only=True)
    self.mean_bbbp_ebd1=torch.mean(self.bbbp_ebd1,dim=0)
    self.bbbp_ebd0=torch.load('AI_Model/AI_model_cache/Property Searching/bbbp_embeddings0.pt',weights_only=True)
    self.mean_bbbp_ebd0=torch.mean(self.bbbp_ebd0,dim=0)
    csv='AI_Model/AI_model_cache/Property Searching/bace.csv'
    df=pd.read_csv(csv)
    smiles=df['smiles']
    labels=df['target']
    ...
    self.bace_ebd1=torch.load('AI_Model/AI_model_cache/Property Searching/bace_embeddings1.pt',weights_only=True)
    self.mean_bace_ebd1=torch.mean(self.bace_ebd1,dim=0)
    self.bace_ebd0=torch.load('AI_Model/AI_model_cache/Property Searching/bace_embeddings0.pt',weights_only=True)
    self.mean_bace_ebd0=torch.mean(self.bace_ebd0,dim=0)
    csv='AI_Model/AI_model_cache/Property Searching/fda.csv'
    df=pd.read_csv(csv)
    smiles=df['smiles']
    labels=df['target']
    ...
    self.fda_ebd1=torch.load('AI_Model/AI_model_cache/Property Searching/fda_embeddings1.pt',weights_only=True)
    self.mean_fda_ebd1=torch.mean(self.fda_ebd1,dim=0)
    self.fda_ebd0=torch.load('AI_Model/AI_model_cache/Property Searching/fda_embeddings0.pt',weights_only=True)
    self.mean_fda_ebd0=torch.mean(self.fda_ebd0,dim=0)
    csv='AI_Model/AI_model_cache/Property Searching/ctox.csv'
    df=pd.read_csv(csv)
    smiles=df['smiles']
    labels=df['target']
    ...
    self.ctox_ebd1=torch.load('AI_Model/AI_model_cache/Property Searching/ctox_embeddings1.pt',weights_only=True)
    self.mean_ctox_ebd1=torch.mean(self.ctox_ebd1,dim=0)
    self.ctox_ebd0=torch.load('AI_Model/AI_model_cache/Property Searching/ctox_embeddings0.pt',weights_only=True)
    self.mean_ctox_ebd0=torch.mean(self.ctox_ebd0,dim=0)
    csv='AI_Model/AI_model_cache/Property Searching/hiv.csv'
    df=pd.read_csv(csv)
    smiles=df['smiles']
    labels=df['target']
    ...
    self.hiv_ebd1=torch.load('AI_Model/AI_model_cache/Property Searching/hiv_embeddings1.pt',weights_only=True)
    self.hiv_ebd0=torch.load('AI_Model/AI_model_cache/Property Searching/hiv_embeddings0.pt',weights_only=True)
