...
class Graph_models1(nn.Module):
    def __init__(self):
        ...
        #Base model
        self.tokenizer = AutoTokenizer.from_pretrained("DeepChem/ChemBERTa-77M-MTR",cache_dir="AI_Model/AI_model_cache/HuggingFace")
        self.base_model=AutoModelForMaskedLM.from_pretrained("DeepChem/ChemBERTa-77M-MTR",cache_dir="AI_Model/AI_model_cache/HuggingFace")
        self.base_model.lm_head=nn.Identity()
        for param in self.base_model.parameters():
            param.requires_grad = False
        #Graph
        self.bbbp_graph=torch.load('AI_Model/AI_model_cache/Graphs/bbbp.pt',map_location=torch.device('cpu'),weights_only=False)
        self.bace_graph=torch.load('AI_Model/AI_model_cache/Graphs/bace.pt',map_location=torch.device('cpu'),weights_only=False)
        self.ctox_graph=torch.load('AI_Model/AI_model_cache/Graphs/ctox.pt',map_location=torch.device('cpu'),weights_only=False)
        self.fda_graph=torch.load('AI_Model/AI_model_cache/Graphs/fda.pt',map_location=torch.device('cpu'),weights_only=False)
        self.hiv_graph=torch.load('AI_Model/AI_model_cache/Graphs/hiv.pt',map_location=torch.device('cpu'),weights_only=False)
        self.esol_graph=torch.load('AI_Model/AI_model_cache/Graphs/esol.pt',map_location=torch.device('cpu'),weights_only=False)
        self.lipophilicity_graph=torch.load('AI_Model/AI_model_cache/Graphs/lipophilicity.pt',map_location=torch.device('cpu'),weights_only=False)
        self.freeSolv_graph=torch.load('AI_Model/AI_model_cache/Graphs/freeSolv.pt',map_location=torch.device('cpu'),weights_only=False)
        self.qm7_graph=torch.load('AI_Model/AI_model_cache/Graphs/qm7.pt',map_location=torch.device('cpu'),weights_only=False)
        self.E1CC2_graph=torch.load('AI_Model/AI_model_cache/Graphs/E1-CC2.pt',map_location=torch.device('cpu'),weights_only=False)
        self.E2CC2_graph=torch.load('AI_Model/AI_model_cache/Graphs/E2-CC2.pt',map_location=torch.device('cpu'),weights_only=False)
        self.E1PBE0_graph=torch.load('AI_Model/AI_model_cache/Graphs/E1-PBE0.pt',map_location=torch.device('cpu'),weights_only=False)
        self.E2PBE0_graph=torch.load('AI_Model/AI_model_cache/Graphs/E2-PBE0.pt',map_location=torch.device('cpu'),weights_only=False)
        self.E1CAM_graph=torch.load('AI_Model/AI_model_cache/Graphs/E1-CAM.pt',map_location=torch.device('cpu'),weights_only=False)
        self.E2CAM_graph=torch.load('AI_Model/AI_model_cache/Graphs/E2-CAM.pt',map_location=torch.device('cpu'),weights_only=False)
        #initialize model
        ...
        self.bbbp_model.load_state_dict(torch.load('AI_Model/AI_model_cache/Graph-Model-Weight/bbbp.pt',map_location=torch.device('cpu'),weights_only=True))
        self.bace_model.load_state_dict(torch.load('AI_Model/AI_model_cache/Graph-Model-Weight/bace.pt',map_location=torch.device('cpu'),weights_only=True))
        self.ctox_model.load_state_dict(torch.load('AI_Model/AI_model_cache/Graph-Model-Weight/ctox.pt',map_location=torch.device('cpu'),weights_only=True))
        self.fda_model.load_state_dict(torch.load('AI_Model/AI_model_cache/Graph-Model-Weight/fda.pt',map_location=torch.device('cpu'),weights_only=True))
        self.hiv_model.load_state_dict(torch.load('AI_Model/AI_model_cache/Graph-Model-Weight/hiv.pt',map_location=torch.device('cpu'),weights_only=True))
        self.esol_model.load_state_dict(torch.load('AI_Model/AI_model_cache/Graph-Model-Weight/esol.pt',map_location=torch.device('cpu'),weights_only=True))
        self.freeSolv_model.load_state_dict(torch.load('AI_Model/AI_model_cache/Graph-Model-Weight/freeSolv.pt',map_location=torch.device('cpu'),weights_only=True))
        self.qm7_model.load_state_dict(torch.load('AI_Model/AI_model_cache/Graph-Model-Weight/qm7.pt',map_location=torch.device('cpu'),weights_only=True))
        self.lipophilicity_model.load_state_dict(torch.load('AI_Model/AI_model_cache/Graph-Model-Weight/lipophilicity.pt',map_location=torch.device('cpu'),weights_only=True))
        self.E1CC2_model.load_state_dict(torch.load('AI_Model/AI_model_cache/Graph-Model-Weight/E1-CC2.pt',map_location=torch.device('cpu'),weights_only=True))
        self.E2CC2_model.load_state_dict(torch.load('AI_Model/AI_model_cache/Graph-Model-Weight/E2-CC2.pt',map_location=torch.device('cpu'),weights_only=True))
        self.E1PBE0_model.load_state_dict(torch.load('AI_Model/AI_model_cache/Graph-Model-Weight/E1-PBE0.pt',map_location=torch.device('cpu'),weights_only=True))
        self.E2PBE0_model.load_state_dict(torch.load('AI_Model/AI_model_cache/Graph-Model-Weight/E2-PBE0.pt',map_location=torch.device('cpu'),weights_only=True))
        self.E1CAM_model.load_state_dict(torch.load('AI_Model/AI_model_cache/Graph-Model-Weight/E1-CAM.pt',map_location=torch.device('cpu'),weights_only=True))
        self.E2CAM_model.load_state_dict(torch.load('AI_Model/AI_model_cache/Graph-Model-Weight/E2-CAM.pt',map_location=torch.device('cpu'),weights_only=True))
